  ...
  useEffect(() => {
    ...
    if (pathname === '/' || pathname === '') {
      ...
      if (!tabs.some((t) => t.id === tabId)) {
        setTabs((prev) => [...prev, { id: tabId, title: 'Bóveda', path: '/vault', closable: true }])
      }
      setActiveTabId(tabId)
    } else if (pathname === '/shares') {
      const tabId = 'shares'
      if (!tabs.some((t) => t.id === tabId)) {
        setTabs((prev) => [...prev, { id: tabId, title: 'Compartidos', path: '/shares', closable: true }])
      }
      setActiveTabId(tabId)
